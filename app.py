...
# ============================================================
# الخطة 2: تفتح فوراً وحراً عند كتابة هاتف جديد تماماً غير مسجل بالاسم (مثال: Infinix Note 60)
# ============================================================
    ...
    if new_size.strip() and str(new_panel).strip() and str(new_sensor).strip():
        ...
        if matched_list:
            ...
            # ============================================================
            st.error("❌ خطة الطوارئ (الخطة 3): لا توجد مجموعة تطابق هذه المواصفات in المكتبة.")
