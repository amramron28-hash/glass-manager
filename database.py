...
def load_db():
    try:
        ...
        # ⚡ كسر شرط التصفير التلقائي وضخ البيانات فوراً إذا كانت البيانات أقل من 5 هواتف
        if len(rows) < 5:
            try:
                bulk_records = []
