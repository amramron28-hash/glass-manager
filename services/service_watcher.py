...
def execute_refresh_logic(
    ...
    try:
        ...
        # تحديث الاقتراحات إذا كان مربع البحث مفتوحًا
        if show_curtain():
